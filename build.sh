...
echo "== 1/5  auto-tests du moteur de cube et du rendu 3D =="
python3 tools/test_cube.py | tail -2
python3 tools/test_render3d.py

echo "== 2/5  verification des algorithmes =="
python3 tools/check_algs.py | tail -4

echo "== 3/5  generation des schemas et des pages (fr, en, bis) =="
python3 tools/build.py

echo "== 4/5  construction des trois sites =="
...
echo "== 5/5  referencement (hreflang, meta, robots.txt, sitemap index) =="
